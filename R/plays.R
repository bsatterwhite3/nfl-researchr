source("../R/plays-functions.R")

########## INPUTS ##########

# filename to store plays
pbp_filename = "~/Documents/sandbox/nfl-researchr/data/pbp.rds"    # replace this with file where you want to play data
sharpe_mutations <- TRUE    # do you want to apply Lee Sharpe's mutations?
name_fixes <- TRUE          # do you want to apply name fixes?
add_positions <- FALSE       # do you want to add columns with player's positions?
baldwin_mutations <- TRUE
